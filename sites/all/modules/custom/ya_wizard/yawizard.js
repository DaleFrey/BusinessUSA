yawizard = {
    ...
    seek: function (toSlideId, fastAndNoHook) {
        ...
        if ( typeof yawizard['slides'][toSlideId]['ajaxLoad'] != 'undefined' && yawizard['slides'][toSlideId]['ajaxLoad'] != '' ) {
            ...
            var dataToSend = {
                ...
                'allTags': yawizard.getAllTags(),
                'inputs': yawizard.getAllTags()
            };
    ...
    getShareLink: function() {
        var currentWizTagQuestionValues = yawizard.getAllTags();
        var requestArr = [];
        jQuery('.wizard .question-container').each( function () {
            var jqThis = jQuery(this);
            var questionNumericalID = jqThis.attr('questionNumericalID');
        ...
        return document.location.protocol + '//' + document.location.host + document.location.pathname + '?' + requestArr.join('&') + '#wizard-step-id-' + yawizard.currentActiveSlide;
    },
