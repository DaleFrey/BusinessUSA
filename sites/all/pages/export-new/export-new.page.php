...
<!-- The following div is rendered from <?php print __FILE__; ?> -->
<div class="exporterdashboard-mastercontainer" rendersource="<?php print basename(__FILE__); ?>">
    
    <!-- /* Coder Bookmark: CB-VIJHGR1-BC in <?php print basename(__FILE__); ?> */ -->
    <ul class="exporterdashboard-major-container">
        <li class="exporterdashboard-major-item exporterdashboard-major-odd exporterdashboard-minor-first">
            <h2>
                <a href="">
                    Learn More
                </a>
        ...
        <li class="exporterdashboard-major-item exporterdashboard-major-even">
            <h2>
                <a href="">
                    Comply with the Law
                </a>
        ...
        <li class="exporterdashboard-major-item exporterdashboard-major-odd exporterdashboard-minor-last">
            <h2>
                <a href="">
                    Seek Assistance
                </a>
    ...
    <ul class="exporterdashboard-minor-container">
        ...
        <li class="exporterdashboard-minor-item exporterdashboard-minor-even exporterdashboard-minor-last">
            <a href="">
    ...
    <div class="exporterdashboard-exportnews-viewcontainer" rendersource="<?php print basename(__FILE__); ?>">
    ...
    <div class="exporterdashboard-useacsevents-container" rendersource="<?php print basename(__FILE__); ?>">
        ...
        <div class="exporterdashboard-useacsevents-head">
            ...
            <div class="exporterdashboard-useacsevents-locationselect-popup-container" style="display: none;">
                <form>
                    ...
                    <select name="countryselector" id="countryselector" class="exporterdashboard-useacsevents-select">
                    ...
                    <input id="zipselector" name="zipselector" type="text" />
        ...
        <div class="exporterdashboard-useacsevents-ajaxcontainer">
            ...
            <div style="line-height: 35px; padding-left: 10px; float: left;">
                Please wait as we search our resources...
            </div>
            
            <div class="exporterdashboard-useacsevents-posthead">
                <span>Current Location: </span>
                <span> <!-- The content of this span shall be filled out by jQuery --> </span>
                <span>Current Location: </span>
            </div>
