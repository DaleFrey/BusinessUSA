...
<?php
    ...
    print theme(
            'yawizard_from_excel', 
            array(
                'path' => overridable('sites/all/pages/find-green-opportunities/wizard-questions.xls'),
                'resultsURL' => '/find-green-opportunities/wizard-results'
            )
    );
?>
...
<script>
    $(document).ready(function(){
        var textbox = $(':input#wiztag-greentext[type="text"]');
        ...
        if (nextSlide != 'undefined' && nextSlide.text().trim() == 'Results'){
