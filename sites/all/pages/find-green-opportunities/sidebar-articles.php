 <div>
    ...
    */
    ...
    $spreadsheetRows = ya_wizard_excelToArray(DRUPAL_ROOT . '/sites/all/pages/find-green-opportunities/Green-Articles.xls'); // ya_wizard_excelToArray() reads a target Excel file, and returns an array of all the rows/cells in the target spreadsheet
