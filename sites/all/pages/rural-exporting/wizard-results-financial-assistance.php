<div class="articles-recommended-container">
    ...
    $potentialResults = ya_wizard_excelToArray('sites/all/pages/rural-exporting/wizard-results-financial-assistance.xls');
    ...
    foreach ( $potentialResults as $key => $potentialResult ) {
        ...
        $anyFromLastSectionIsBothOfInterestAndSelected = intval(
            $dairy || $plants || $loans || $grants || $cost_sharing_funding || $regulation_yes || $credit_guarantees || $research_yes || $disaster_yes || $transportation || $foreign_markets ||
            $manufacturing || $trade_show || $production_distribution || $help_yes
        );
