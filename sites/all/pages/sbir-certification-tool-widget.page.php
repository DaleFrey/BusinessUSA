<style>
  .sbir-certification-tool-mastercontainer-wrapper .widget-spacer {
    background: #797979;
    height: 30px;
    clear: both;
  }
  .sbir-certification-tool-mastercontainer-wrapper .input_hidden {
    position: absolute;
    left: -9999px;
  }

  .sbir-certification-tool-mastercontainer-wrapper #employees label,
  .sbir-certification-tool-mastercontainer-wrapper #ownership label,
  .sbir-certification-tool-mastercontainer-wrapper #organized label,
  .sbir-certification-tool-mastercontainer-wrapper #location label {
  ...
  #cboxLoadedContent .vendorLightBox-logo {
    margin: 0px;
  }

  .body.node-type-program #colorbox #cboxWrapper #cboxContent #cboxLoadedContent {
    background: none;
    padding: 0px;
  }

  #cboxLoadedContent .vendorLightBox-msg-area {
    margin: 0px;
    width: 100%;
  }
</style>
    <div class="sbir-certification-tool-mastercontainer-wrapper">
        <div class="sbir-certification-tool-mastercontainer">
            ...
            <div id="div_profit" class="hidden" >
							<a href="javascript: " title="Click here to learn more">[why?]</a>
						</div>
            ...
            <label id="lbllocation">Not yet answered</label>
                ...
                <div class="cell3">
                    ...
                    <div id="div_employee" class="hidden">
                        <a href="" title="Click here to learn more">[why?]</a>
                    </div>
                </div>
            </div>
			</div>
