...
<div>
    ...
    $spreadsheetRows = ya_wizard_excelToArray(__DIR__ . '/TaxesAndCredits-Articles.xls'); // ya_wizard_excelToArray() reads a target Excel file, and returns an array of all the rows/cells in the target spreadsheet
