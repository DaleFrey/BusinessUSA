jQuery(document).ready( function () {
    jQuery('body').addClass('myusa-frontpage');
})

/* Include the GoogleMap-API as needed */
jQuery(document).ready( function () {
    map = null;
    var mapOptions = {
        zoom: 4,
...
// Event handelers for the "Saved Resources & Tools" section
jQuery(document).ready( function () {
    jQuery('.tiles-pagesnavigation-left, .dot-nav-anchor-page1').bind('click', function () {
        if ( jQuery('.dot-nav-anchor-page2').hasClass('active') ) {
            jQuery('.tiles-pages-page-1').show('slide', {direction: 'left'}, 1000);
            jQuery('.tiles-pages-page-2').hide('slide', {direction: 'right'}, 1000);
            jQuery('.dot-nav-anchor').toggleClass('active');
            jQuery('.dot-nav-anchor img').toggleClass('active-img');
        }
    });
    jQuery('.tiles-pagesnavigation-right, .dot-nav-anchor-page2').bind('click', function () {
        if ( jQuery('.dot-nav-anchor-page1').hasClass('active') ) {
            jQuery('.tiles-pages-page-1').hide('slide', {direction: 'left'}, 1000);
            jQuery('.tiles-pages-page-2').show('slide', {direction: 'right'}, 1000);
            jQuery('.dot-nav-anchor').toggleClass('active');
            jQuery('.dot-nav-anchor img').toggleClass('active-img');
        }
    });
...
jQuery(document).ready( function () {
    ...
    jQuery('.mobile-gmap-icon').bind('click', function () {
        toggleGMapVisibility();
    });
});

// Event handlers for the accordion implementation (seen in mobile view of this page)
jQuery(document).ready( function () {
    jQuery('.userdashboard-section-titlebar').bind('click', function () {
        var jqThis = jQuery(this);
        if ( jQuery(window).width() < 768 ) { // If we are in mobile view...
            jqThis.toggleClass('expanded');
            jqThis.toggleClass('collapsed');
            jqThis.parents('.userdashboard-section-container').find('.userdashboard-section-body').slideToggle();
        }
    });
});
