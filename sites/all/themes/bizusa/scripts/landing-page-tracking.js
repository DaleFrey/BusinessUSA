...
jQuery(document).ready(function(){
  ...
  if ( isLandingPage == true ) {
    ...
    if (landingPageTracking.length >= 5)
    {
      ...
      jQuery.get(busaLandingPageReportURL, queryData, function (data) { // Send an HTTP-Get request to the server at the URL of busaLandingPageReportURL with the URL-query of queryData
