...
?>
<?php
    if(strpos($_SERVER['REDIRECT_URL'], "/events/") !== FALSE || $_SERVER['REDIRECT_URL'] == '/events'){
        if($event = node_load($variables['result']['node']->entity_id)){
...
<div class="search-result-container <?php print $classes; ?> search-result-<?php print $variables['result']['bundle']; ?> search-result-title-<?php print $titleInContainerClass ?>">
    ...
    <div class="search-result-content-type">
      ...
      ?>
      <img src="<?php print $iconURL; ?>" class="search-result-icon-img" alt="Icon for this <?php echo $variables['result']['bundle']; ?> result" note="This img is rendered from the search-result.overridable.tpl.php file">
                ...
                switch ( $cTypeCompare ) {
                    case 'challenge':
                        if ( !empty($variables['fullNode']->field_challenge_url['und'][0]['url']) ) {
                            print '<!-- This search-result link has been altered since it is of the "challenges" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-PLSV9M7-BC */ -->';
                    ...
                    case 'export article':
                        if ( !empty($variables['fullNode']->field_exportrip_origin['und'][0]['value']) ) {
                            print '<!-- This search-result link has been altered since it is of the "export article" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-OCHLUZL-BC */ -->';
                    ...
                    case 'grant':
                        if ( !empty($variables['fullNode']->field_grants_link['und'][0]['url']) ) {
                            print '<!-- This search-result link has been altered since it is of the "grants" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-KG7VKU7-BC */ -->';
                    ...
                    case 'green_sbir_topic':
                        if ( !empty($variables['fullNode']->field_url['und'][0]['url']) ) {
                            print '<!-- This search-result link has been altered since it is of the "green_sbir_topic" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-00EO11V-BC */ -->';
                            $url = $variables['fullNode']->field_url['und'][0]['url'];
                            $forceRelativeLink = false;
                        }
                        break;
                    case 'knowledgebase article':
                        print '<!-- This search-result link has been altered since it is of the knowledgebase_article content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-7F9IYIG-BC */ -->';
                    ...
                    case 'patent':
                        if ( !empty($variables['fullNode']->field_patent_purl_url['und'][0]['url']) ) {
                            print '<!-- This search-result link has been altered since it is of the "patent" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-0MR1RNG-BC */ -->';
                            $url = $variables['fullNode']->field_patent_purl_url['und'][0]['url'];
                            $forceRelativeLink = false;
                        }
                        break;
                    case 'quick fact':
                        print '<!-- This search-result link has been altered since it is of the Quick Fact content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-NB3T4VU-BC */ -->';
                        $url = '/quick-facts?highlight=' . $variables['result']['node']->entity_id;
                        break;
                    case 'solicitation':
                        if ( !empty($variables['fullNode']->field_presol_link['und'][0]['url']) ) {
                            print '<!-- This search-result link has been altered since it is of the "solicitation" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-BY88XL0-BC */ -->';
                    ...
                    case 'swim-lane page':
                        if ( !empty($variables['fullNode']->field_swimlane_wizurl['und'][0]['value']) ) {
                            print '<!-- This search-result link has been altered since it is of the "swim-lane page" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-BAL3WH3-BC */ -->';
                            $url = '/' . $variables['fullNode']->field_swimlane_wizurl['und'][0]['value'];
                        }
                        break;
                    case 'wizard-result reference for solr':
                        if ( !empty($variables['fullNode']->field_wizref_url['und'][0]['value']) ) {
                            print '<!-- This search-result link has been altered since it is of the "wizard-result reference for solr" content-type - this alteration done within search-result.overridable.tpl.php /* Coder Bookmark: CB-XG2E8BS-BC */ -->';
...
<?php
} //end else if entity type is not an event
